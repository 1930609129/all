...
# viode=html.xpath('//ul[@id="listvideoListUl"]/li')
#
# for li in viode:
#     vio='https://www.pearvideo.com/'+li.xpath('./div/a/@href')[0]
#     name=li.xpath('./div/a/div[2]/text()')[0]+'.mp4'
#     vtext=requests.get(url=vio,headers=head).text
#     print(vtext)
import requests
from lxml import etree
...
def init():
    ...
    for li in tree.xpath("//ul[@id='listvideoListUl']/li"):
        ...
        # 真实的下载地址
        down_url = down_url.replace(need_replace,replaced)   #replaced替换need_replace
